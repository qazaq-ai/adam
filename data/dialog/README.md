...
- `templates/v1.toml` — current template repository (v0.8.5, 29
  families). One file per major schema version. Older schema
  versions, when they arrive, will live alongside as `v2.toml`,
  `v3.toml`, … with the crate loader picking the newest it supports.
