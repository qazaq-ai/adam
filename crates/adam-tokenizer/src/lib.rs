...
mod tests {
    ...
    fn builds_experiment_report_with_segmentation_scoring() {
        ...
        assert_eq!(report.segmentation_example_count, 73);
        assert_eq!(report.exact_match_count, 73);
