...
pub const VERBS: &[LexEntry] = &[
    ...
    LexEntry::new("v_oqy", "оқы", &[O, Q], Pos::Verb, "verb_stem"),    // read! — final «ы» drops
    LexEntry::new("v_kor", "көр", &[K, Oe, R], Pos::Verb, "verb_stem"), // see!
    LexEntry::new("v_bil", "біл", &[B, L], Pos::Verb, "verb_stem"), // know! — orthographic «і» drops
    ...
    LexEntry::new("v_aly", "алы", &[A, L], Pos::Verb, "verb_stem"), // take (informal) — final «ы» drops
    LexEntry::new("v_ber", "бер", &[B, E, R], Pos::Verb, "verb_stem"), // give!
    LexEntry::new("v_jasa", "жаса", &[Zh, A, S, A], Pos::Verb, "verb_stem"), // make / do!
    LexEntry::new("v_uqy", "ұқы", &[U, Q], Pos::Verb, "verb_stem"), // understand — final «ы» drops
    ...
    LexEntry::new("v_biluu", "білу", &[B, L, W], Pos::Verb, "verb_inf"), // to know — orthographic «і» drops
    LexEntry::new(
        "v_jasauu",
        "жасау",
        &[Zh, A, S, A, W],
