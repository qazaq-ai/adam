    ...
    pub fn canonical() -> Self {
        Self {
            ...
            capabilities_summary: "Қазақ тілінде сөйлесе аламын; есіміңізді, жасыңызды, \
                ...
                .into(),
            knowledge_summary: "Менің білімім 38 саладан құралған. Мектеп пәндері: \
                математика, информатика, физика (механика, термодинамика, электр, оптика, \
                атом физикасы), химия (периодтық жүйе, химиялық байланыстар, реакциялар, \
                ерітінділер, органикалық химия), биология (жасуша, өсімдіктер, жануарлар, \
                адам ағзасы, генетика, экология), тарих (ежелгі дәуір, түрік қағанаттары, \
                қазақ хандығы, кеңестік кезең, тәуелсіздік). Бағдарламалау тілін білемін: \
                иелік, трейттер, тіршілік мерзімдері, итераторлар. Қазақстан туралы: \
                17 облыс пен әкімшілік орталықтары, ірі қалалар, тұрғын саны; ірі өзендер \
                (Ертіс, Сырдария, Іле, Жайық, Есіл, Тобыл, Шу, Қаратал, Талас); көлдер \
                мен теңіздер (Балқаш, Каспий, Арал, Зайсан, Алакөл, Тенгіз, Маркакөл); \
                таулар (Алтай, Тянь-Шань, Жетісу Алатауы, Қаратау, Ұлытау, Хан Тәңірі); \
                шөлдер (Бетпақдала, Қызылқұм, Үстірт, Мойынқұм); көрікті жерлер (Бурабай, \
                Шарын каньоны). Қазақ әдебиеті: Әуезов, Сейфуллин, Мүсірепов, Жансүгіров, \
                Жұмабаев, Махамбет, Шәкәрім, Алтынсарин. Танымал қазақстандықтар: \
                Назарбаев, Тоқаев, Қонаев, Бөкейхан, Абылай хан, Сәтбаев, Уәлиханов, \
                Молдағұлова. Жалпы білім: жануарлар, өсімдіктер, дене мүшелері, киім, \
                тағам, түстер, кәсіптер, құрал-сайман, көлік, ауа-райы, аспан денелері, \
                өлшемдер, ыдыс-аяқ, туыстық, музыка, мақал-мәтелдер"
                .into(),
