//! `adam-chat` — interactive REPL for the adam v3.4 Kazakh dialog pipeline.
//!
//! **Kazakh-only surface** (v1.1.0 revert). Input and output are both Kazakh.
//!
//! Capabilities at v3.4:
//!
...
fn main() -> ExitCode {
    ...
    eprintln!("adam-chat v3.4 — пікірлесейік! Қазақ тілінде сөйлесейік; ^D to quit.");
    let stdin = io::stdin();
