//! `adam-chat` — interactive REPL for the adam v6.0 Kazakh dialog
//! pipeline.
//!
//! **Kazakh-only surface** (v1.1.0 revert). Input and output are
//! both Kazakh.
//!
//! Capabilities at v6.0 (v6.0.0 GA merged 2026-05-22):
//!
//!   - **41 intent variants** — conversational + safety + system-
//!     identity aspects + curriculum + code-task + Insult-as-
//!     polite-refusal.
//!   - **3 461 curated world_core entries / 4 114 facts /
//!     66 domains** (regenerated by `extract_facts` from
//!     `data/world_core/*.jsonl`).
