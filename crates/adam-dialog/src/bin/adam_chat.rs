//! `adam-chat` — interactive REPL for the adam v3.7.5 Kazakh dialog pipeline.
//!
//! **Kazakh-only surface** (v1.1.0 revert). Input and output are both Kazakh.
//!
//! Capabilities at v3.7.5:
//!
...
fn main() -> ExitCode {
    ...
    eprintln!("adam-chat v3.7.5 — пікірлесейік! Қазақ тілінде сөйлесейік; ^D to quit.");
    let stdin = io::stdin();
