...
// you want to A/B another pack — e.g. the v6.6 diction-augmented
// pack at `data/curated/adam_intent_training_pack_v6_6_diction.json`
// generated by `scripts/build_diction_pack.py` (linguistically
// grounded drifts mirroring the ~80% poor-diction runtime distribution
// per the 2026-06-13 user directive).
const TRAIN_PACK_DEFAULT: &str = "data/curated/adam_intent_training_pack.json";
...
fn main() {
    ...
    let pack_path = std::env::args()
        ...
        .unwrap_or_else(|| {
            std::env::var("ICX_TRAIN_PACK").unwrap_or_else(|_| TRAIN_PACK_DEFAULT.to_string())
        });
