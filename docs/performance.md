# Performance — adam v6.1.35 (deterministic path; neural preview + AnswerIR are opt-in)

> **v6.1.35 note (originally drafted 2026-05-18 for rc1; the
> 2026-05-22 GA merge held the numbers; v6.1.35 on 2026-05-23 adds
...
> v6.1.35 (identical behaviour to v6.0.0 / v5.32.0 — opt-in neural
> transducers and the v6.1.35 AnswerIR composer do not change the
...
> file remains the deterministic-path baseline that v6.1 must not
> regress against.
