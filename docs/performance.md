# Performance — adam v6.4.0-rc11 (v6.2 deterministic core unchanged; v6.3 wraps it in a voice surface — see DUE_DILIGENCE.md)
...
> v6.1.50 (identical behaviour to v6.0.0 / v5.32.0 — opt-in neural
> transducers and the v6.1.50 AnswerIR composer do not change the
