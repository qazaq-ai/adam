# Performance — adam v6.1.30 (deterministic path; neural preview + AnswerIR are opt-in)

> **v6.1.30 note (originally drafted 2026-05-18 for rc1; the
> 2026-05-22 GA merge held the numbers; v6.1.30 on 2026-05-23 adds
...
> v6.1.30 (identical behaviour to v6.0.0 / v5.32.0 — opt-in neural
> transducers and the v6.1.30 AnswerIR composer do not change the
