# Архитектурное видение agglutinative-neural (черновик Day 1, pre-lit)

> ⚠️ **Этот документ — pre-lit черновик, сохраняется для исторической ценности.** Написан ДО получения [`lit_scan.md`](lit_scan.md). Актуальное обновлённое видение — в [`reconciliation.md`](reconciliation.md), который сравнивает этот черновик с реальным landscape'ом.

**Статус:** pre-lit draft v0.1, 2026-05-15 (Phase 0 Day 1 morning).

Цель этого документа — зафиксировать первую гипотезу ДО того, как литература сместит мышление. Reconciliation сравнивает его с фактическим состоянием поля.
