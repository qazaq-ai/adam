...
<p align="center">
  <a href="https://github.com/qazaq-ai/adam/releases"><img src="https://img.shields.io/badge/version-4.0.13-2EA44F?style=for-the-badge" alt="version"></a>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-471%20passing-2EA44F?style=flat-square" alt="tests">
  <img src="https://img.shields.io/badge/reasoning%20rules-8%20active-2EA44F?style=flat-square" alt="reasoning rules">
...
| Workspace tests | **471 passing, 0 failing, 0 warnings** |
...
| **Reasoning rules active** | **8 of 9 firing on v4.0.13 corpus** — R1 IsA-transitivity (**473**), R2 Has-inheritance (**454**), R3 Has-via-PartOf (**43**), R5 shared-IsA → RelatedTo (**12 791**), R6 LivesIn-via-PartOf (**41**), R7 GoesTo-via-PartOf (**380**), R8 After-transitivity (**734**), **R9 PartOf-transitivity (117, NEW in v4.0.13)**. R4 IsA-symmetry is curator-warning only. **R8 + R9 are both mathematically clean** — partial-order transitive closures with no semantic overreach; R9 activated R3/R6/R7 cross-rule cascades (R7 +24 %, R3 +54 %). |
...
| **Rule-derived facts (committed runtime)** | **15 033** (v4.0.13: R1=473, R2=454, R3=**43**, R5=12 791, R6=41, R7=**380**, R8=734, **R9=117 NEW**). Delta vs v4.0.12: **+197 (+1.3 %)** from R9 activation. R9 direct 117 plus cross-activation: R3 +15 (+54 %), R7 +74 (+24 %), R6 +4. **Cumulative v4.0.7 → v4.0.13**: **7 866 → 15 033 derivations (+91.1 %)** across 7 releases |
