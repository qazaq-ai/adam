...
<p align="center">
  <a href="https://github.com/qazaq-ai/adam/releases"><img src="https://img.shields.io/badge/version-5.19.0-2EA44F?style=for-the-badge" alt="version"></a>
...
<p align="center">
  <img src="https://img.shields.io/badge/tests-1358%20passing-2EA44F?style=flat-square" alt="tests">
...
| Metric | Value | Notes |
|---|---|---|
| Workspace tests | **1 358 passing** | + 17 ignored + adversarial_dialog_v1 (95 cases, **100%** all 10 categories); voice V3 normalizer + Kazakh priming prompt; CI on every release |
