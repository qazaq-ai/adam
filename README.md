...
<p align="center">
  <a href="https://github.com/qazaq-ai/adam/releases"><img src="https://img.shields.io/badge/version-4.11.0-2EA44F?style=for-the-badge" alt="version"></a>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/world%20core-1593%20curated%20/%201756%20facts-9CCC65?style=flat-square" alt="world core">
  <img src="https://img.shields.io/badge/domains-37-9CCC65?style=flat-square" alt="domains">
...
|---|---|---|
| Workspace tests | **745 passing, 0 failing, 4 ignored** | `cargo test --workspace` |
...
| Facts (committed runtime) | **16 282 total** = **14 526 extracted (Grammar)** + **1756 curated (HumanApproved, 37 domains)**. T4_200k scale |
| **Rule-derived facts (committed runtime)** | **29 976 derivations** in 5 passes (10 active rules; numeric breakdown in the rules row above) |
| Fact-graph nodes / edges | **4 267 / 14 542** (committed v4.11.0); most-connected content nouns scaled with Lexicon sync |
