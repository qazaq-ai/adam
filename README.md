...
<p align="center">
  <a href="https://github.com/qazaq-ai/adam/releases"><img src="https://img.shields.io/badge/version-5.20.0-2EA44F?style=for-the-badge" alt="version"></a>
...
<p align="center">
  <img src="https://img.shields.io/badge/tests-1367%20passing-2EA44F?style=flat-square" alt="tests">
  ...
  <img src="https://img.shields.io/badge/world%20core-3124%20curated%20/%203404%20facts%20%2F%2060%20domains-9CCC65?style=flat-square" alt="world core">
...
| Metric | Value | Notes |
|---|---|---|
| Workspace tests | **1 367 passing** | + 17 ignored + adversarial_dialog_v1 (95 cases, **100%** all 10 categories); voice V3 normalizer + priming + Kazakh-phonetic fuzzy entity matcher; CI on every release |
...
| Curated facts | **3 404** (3 124 entries) | across 60 world_core domains; `validate_world_core` enforced in CI |
